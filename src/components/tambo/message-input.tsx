...
const messageInputVariants = cva("w-full", {
  variants: {
    variant: {
      default: [
        "[&>[data-slot=message-input-container]]:bg-background",
        "[&>[data-slot=message-input-container]]:border",
        "[&>[data-slot=message-input-container]]:border-border",
        "[&>[data-slot=message-input-container]]:shadow-md",
        "[&>[data-slot=message-input-container]]:p-2",
        "[&>[data-slot=message-input-container]]:px-3",
      ].join(" "),
      solid: [
        "[&>[data-slot=message-input-container]]:bg-background",
        "[&>[data-slot=message-input-container]]:border-0",
        "[&>[data-slot=message-input-container]]:shadow-xl [&>[data-slot=message-input-container]]:shadow-black/5 [&>[data-slot=message-input-container]]:dark:shadow-black/20",
        "[&>[data-slot=message-input-container]]:ring-1 [&>[data-slot=message-input-container]]:ring-black/5 [&>[data-slot=message-input-container]]:dark:ring-white/10",
        "[&>[data-slot=message-input-container]]:p-2",
        "[&>[data-slot=message-input-container]]:px-3",
      ...
      bordered: [
        "[&>[data-slot=message-input-container]]:bg-transparent",
        "[&>[data-slot=message-input-container]]:border-2 [&>[data-slot=message-input-container]]:border-gray-300 [&>[data-slot=message-input-container]]:dark:border-zinc-600",
        "[&>[data-slot=message-input-container]]:shadow-none",
        "[&>[data-slot=message-input-container]]:p-2",
        "[&>[data-slot=message-input-container]]:px-3",
        "[&_textarea]:bg-transparent",
        "[&_textarea]:border-0",
      ...
      ghost: [
        "[&>[data-slot=message-input-container]]:bg-transparent",
        "[&>[data-slot=message-input-container]]:border-none",
        "[&>[data-slot=message-input-container]]:shadow-none",
        "[&>[data-slot=message-input-container]]:p-0",
        "[&>[data-slot=message-input-container]]:gap-0",
      ].join(" "),
    },
  },
  defaultVariants: {
...
>(({ children, className, variant, inputRef, ...props }, ref) => {
  ...
  return (
    ...
    >
      ...
      >
        <div
          data-slot="message-input-container"
          className={cn(
