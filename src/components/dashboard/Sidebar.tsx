...
import { FileText, LogOut, Building2, Plus, ChevronsUpDown, Check } from "lucide-react";
...
export function Sidebar({ organization, organizations = [], user, profile, onOrgChange }: SidebarProps) {
    ...
    return (
        <aside className="fixed left-0 top-0 h-screen w-64 md:w-72 bg-white border-r-2 border-dashed border-black flex flex-col p-6 z-40 hidden md:flex">
            ...
            <div className="mb-8 relative" ref={dropdownRef}>
                ...
                >
                    ...
                    <div className="flex-1 min-w-0">
                        <h1 className="text-lg font-bold text-black truncate font-[family-name:var(--font-cursive)]">
